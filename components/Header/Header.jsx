              ...
              <div className={`${classes.nav__right}`}>
                ...
                >
                  <Link
                    ...
                    id="youtube-channel"
                    className={`cursor-pointer  text-[#ffffff] hover:text-[red] transform ease-in-out hover:-translate-y+1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <RiYoutubeFill />
                  </Link>
                  ...
                  <Link
                    ...
                    id="github-account"
                    className={`cursor-pointer text-[#ffffff] hover:text-[black] transform ease-in-out hover:-translate-y+1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <RiGithubFill />
                  </Link>
                  ...
                  <Link
                    ...
                    id="linkedin-account"
                    className={`cursor-pointer text-[#ffffff] hover:text-[#009dff] transform ease-in-out hover:-translate-y+1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <RiLinkedinFill />
                  </Link>
