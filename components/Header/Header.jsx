              ...
              <div className={`${classes.nav__right}`}>
                ...
                >
                  <Link
                    ...
                    id="youtube-channel"
                    className={`cursor-pointer text-red-500 transform ease-in-out hover:-translate-y-1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <RiYoutubeFill />
                  </Link>
                  ...
                  <Link
                    ...
                    id="github-account"
                    className={`cursor-pointer text-[#2ea44f] transform ease-in-out hover:-translate-y-1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <RiGithubFill />
                  </Link>
                  ...
                  <Link
                    ...
                    id="twitter-account"
                    className={`cursor-pointer text-white hover:text-black transform ease-in-out hover:-translate-y-1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <NewTwitterLogo />
                  </Link>
                  ...
                  <Link
                    ...
                    id="linkedin-account"
                    className={`cursor-pointer text-[#0077B5] hover:text-[#0A66C2] transform ease-in-out hover:-translate-y-1 hover:scale-150`}
                    rel="noreferrer"
                  >
                    <RiLinkedinFill />
                  </Link>
