            ...
            {submitted ? (
              ...
              <>
                ...
                <form className="flex flex-col space-y-4" onSubmit={handleSubmit}>
                  <input
                    className="text-md border-transparent rounded-lg block w-full p-2.5 bg-[#171f38] placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-[#01d293]"
                    type="text"
                    name="name"
